...
var Mention = function (_React$Component) {
  ...
  _createClass(Mention, [{
    ...
    value: function render() {
      ...
      var editorClass = classnames(className, (_classnames = {}, _defineProperty(_classnames, prefixCls + '-wrapper', true), _defineProperty(_classnames, 'readonly', readOnly), _defineProperty(_classnames, 'disabled', disabled), _defineProperty(_classnames, 'multilines', multiLines), _classnames));
