...
exports.getMentions = exports.toEditorState = exports.toContentString = exports.Nav = undefined;
...
_Mention2['default'].toContentString = _exportContent2['default'];
_Mention2['default'].toEditorState = toEditorState;
_Mention2['default'].getMentions = _getMentions2['default'];

exports.Nav = _Nav2['default'];
exports.toContentString = _exportContent2['default'];
